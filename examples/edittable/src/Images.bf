...
struct ImageFile
{
    ...
    public this(String e_name, uint8* e_data, int32 e_width, int32 e_height, int32 e_stride)
    {
        name = e_name;
        data = e_data;
        width = e_width;
...
class Images
{
    private var _files = new List<ImageFile>() ~ delete _;

    public this()
    {
        _files.Add(ImageFile("andlabs_16x16test_24june2016.png", &dat0[0], 16, 16, 64));
        _files.Add(ImageFile("andlabs_32x32test_24june2016.png", &dat1[0], 32, 32, 128));
        _files.Add(ImageFile("tango-icon-theme-0.8.90_16x16_x-office-spreadsheet.png", &dat2[0], 16, 16, 64));
        _files.Add(ImageFile("tango-icon-theme-0.8.90_32x32_x-office-spreadsheet.png", &dat3[0], 32, 32, 128));
    }
    ...
    public void appendImageNamed(UiImage img, String name)
    {
